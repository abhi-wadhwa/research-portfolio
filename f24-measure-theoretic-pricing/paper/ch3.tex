...
This is the most important special case and I kept getting confused about it until I worked through three examples. Let $f : \R^n \to \R$ be Lipschitz. Then $J_f = |\nabla f|$. The coarea formula becomes
\[
...
This comes from the coarea formula with $g = \chi_A$ and the bound $|\nabla u| \leq \Lip(u)$. It tells us that ``most'' level sets of a Lipschitz function are nice $(n-1)$-dimensional surfaces. The bad ones form a null set in the target. This connects directly to the theory of sets of finite perimeter later on.
